...
class VPC_Public {
	...
	wp_enqueue_style( "vpc-public-css", plugin_dir_url( __FILE__ ) . 'css/vpc-public.css', array(), $this->version, 'all' );
 }
...
//        $aVars[] = "vpc-pid";
	...
	if ( $wrap )
		...
		$setting_page	 = admin_url( 'edit.php?post_type=vpc-config&page=vpc-manage-settings' );
		$design_url	 = "<div id='vpc-missing-configurator-page'>Please set configurator page on <a href='$setting_page'>settings page</a>.</div>";
	    }
