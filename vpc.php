 ...
 *
 * @link              https://www.orionorigin.com/product/visual-product-configurator-for-woocommerce/?utm_source=Installed+free+plugin&utm_medium=Source+code&utm_campaign=VPC
 * @since             1.0.0
 * @package           Vpc
 *
 * @wordpress-plugin
 * Plugin Name:       Visual Products Configurator - Free
 * Plugin URI:        https://www.orionorigin.com/product/visual-product-configurator-for-woocommerce/?utm_source=Installed+free+plugin&utm_medium=Plugin+URI&utm_campaign=VPC
 * Description:       Configure, build, design and customize any product visually prior to purchase.
 * Version:           3.5
 * Author:            ORION
 * Author URI:        https://www.orionorigin.com/?utm_source=Installed+free+plugin&utm_medium=Author+URI&utm_campaign=VPC
...
define('VPC_VERSION', '3.5' );
if ( ! defined( 'ORION_SERVER_API_ROUTES') ) {
	define( 'ORION_SERVER_API_ROUTES', 'https://orionorigin.com/service' );
}
